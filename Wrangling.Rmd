...
week2edit <- weeks %>%
  ...
  select(x,y,event, nflId, displayName, position, team, gameId, playId, playDirection)%>%
  group_by(gameId, playId) %>%
  right_join(plays, week2edit, by = c("playId", "gameId")) %>%
  filter(event != "NA")
...
week3edit <- weeks %>%
  ...
  select(x,y,event, nflId, displayName, position, team, gameId, playId, playDirection)%>%
  group_by(gameId, playId) %>%
  right_join(plays, week3edit, by = c("playId", "gameId")) %>%
  filter(event != "NA")
...
week4edit <- weeks %>%
  ...
  select(x,y,event, nflId, displayName, position, team, gameId, playId, playDirection)%>%
  group_by(gameId, playId) %>%
  right_join(plays, week4edit, by = c("playId", "gameId")) %>%
  filter(event != "NA")
...
week5edit <- weeks %>%
  ...
  select(x,y,event, nflId, displayName, position, team, gameId, playId, playDirection)%>%
  group_by(gameId, playId) %>%
  right_join(plays, week5edit, by = c("playId", "gameId")) %>%
  filter(event != "NA")
...
week6edit <- weeks %>%
  ...
  select(x,y,event, nflId, displayName, position, team, gameId, playId, playDirection)%>%
  group_by(gameId, playId) %>%
  right_join(plays, week6edit, by = c("playId", "gameId")) %>%
  filter(event != "NA")
...
week7edit <- weeks %>%
  ...
  select(x,y,event, nflId, displayName, position, team, gameId, playId, playDirection)%>%
  group_by(gameId, playId) %>%
  right_join(plays, week7edit, by = c("playId", "gameId")) %>%
  filter(event != "NA")
...
week8edit <- weeks %>%
  ...
  select(x,y,event, nflId, displayName, position, team, gameId, playId, playDirection)%>%
  group_by(gameId, playId) %>%
  right_join(plays, week8edit, by = c("playId", "gameId")) %>%
  filter(event != "NA")
...
week9edit <- weeks %>%
  ...
  select(x,y,event, nflId, displayName, position, team, gameId, playId, playDirection)%>%
  group_by(gameId, playId) %>%
  right_join(plays, week9edit, by = c("playId", "gameId")) %>%
  filter(event != "NA")
...
week10edit <- weeks %>%
  ...
  select(x,y,event, nflId, displayName, position, team, gameId, playId, playDirection)%>%
  group_by(gameId, playId) %>%
  right_join(plays, week10edit, by = c("playId", "gameId")) %>%
  filter(event != "NA")
...
week11edit <- weeks %>%
  ...
  select(x,y,event, nflId, displayName, position, team, gameId, playId, playDirection)%>%
  group_by(gameId, playId) %>%
  right_join(plays, week11edit, by = c("playId", "gameId")) %>%
  filter(event != "NA")
...
week12edit <- weeks %>%
  ...
  select(x,y,event, nflId, displayName, position, team, gameId, playId, playDirection)%>%
  group_by(gameId, playId) %>%
  right_join(plays, week12edit, by = c("playId", "gameId")) %>%
  filter(event != "NA")
...
week13edit <- weeks %>%
  ...
  select(x,y,event, nflId, displayName, position, team, gameId, playId, playDirection)%>%
  group_by(gameId, playId) %>%
  right_join(plays, week13edit, by = c("playId", "gameId")) %>%
  filter(event != "NA")
...
week14edit <- weeks %>%
  ...
  select(x,y,event, nflId, displayName, position, team, gameId, playId, playDirection)%>%
  group_by(gameId, playId) %>%
  right_join(plays, week14edit, by = c("playId", "gameId")) %>%
  filter(event != "NA")
...
week15edit <- weeks %>%
  ...
  select(x,y,event, nflId, displayName, position, team, gameId, playId, playDirection)%>%
  group_by(gameId, playId) %>%
  right_join(plays, week15edit, by = c("playId", "gameId")) %>%
  filter(event != "NA")
...
week16edit <- weeks %>%
  ...
  select(x,y,event, nflId, displayName, position, team, gameId, playId, playDirection)%>%
  group_by(gameId, playId) %>%
  right_join(plays, week16edit, by = c("playId", "gameId")) %>%
  filter(event != "NA")
...
week17edit <- weeks %>%
  ...
  select(x,y,event, nflId, displayName, position, team, gameId, playId, playDirection)%>%
  group_by(gameId, playId) %>%
  right_join(plays, week17edit, by = c("playId", "gameId")) %>%
  filter(event != "NA")


combined_edits <- combine(week1edit, week2edit, week3edit, week4edit, week5edit, week6edit, week7edit, week8edit, week9edit, week10edit, week11edit, week12edit, week13edit, week14edit, week15edit, week16edit, week17edit)
