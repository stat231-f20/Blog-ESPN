...
plays <- read_csv("DATA//nfl-big-data-bowl-2021/plays.csv")
week1 <- read_csv("DATA//nfl-big-data-bowl-2021/week1.csv")
week2 <- read_csv("DATA//nfl-big-data-bowl-2021/week2.csv")
week3 <- read_csv("DATA//nfl-big-data-bowl-2021/week3.csv")



count(week1, event)
#wrangled dat 
#join by gameID play Id
...
#dataframe of relevant variables from plays

plays1 <- plays %>%
  
  

#first down percentage, yardline, player result, play type, player position, yards to go, down, penaltyCodes, 
