...
- go to stat231-f20.github.io/blog-espn/ to see the published test document (this is publicly available!)
...
You can include [Links](https://www.datadreaming.org/post/r-markdown-theme-gallery/) and images inline with text ![amherst mammoths](https://www.amherst.edu/system/files/styles/original/private/media/Mammoth_Icon_PurpleRGB.png)
